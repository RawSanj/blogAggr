...
import com.rawsanj.blogaggr.web.filter.CachingHttpHeadersFilter;
import com.rawsanj.blogaggr.web.filter.StaticResourcesProductionFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initStaticResourcesProductionFilter(ServletContext servletContext,
        ...
        staticResourcesProductionFilter.addMappingForUrlPatterns(disps, true, "/logs/*");
